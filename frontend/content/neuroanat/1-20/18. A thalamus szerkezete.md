...
Az alábbi táblázat összefoglalja a thalamus főbb magcsoportjait és magjait, azok főbb kapcsolatait és funkcióit:

|Magcsoport/Mag|Fő Afferensek|Fő Efferensek|Kulcsfunkciók|Források|
|---|---|---|---|---|
|**Nuclei Anteriores Thalami** (AV, AD, AM)|Corpus mammillare (Tr. mammillothalamicus), Hippocampus (Fornix), Hypothalamus, Gyrus cinguli|Gyrus cinguli (anterior), Prefrontális kéreg (AM, AV), Retrospleniális kéreg, Subiculum|Memória (epizodikus, térbeli), Emóciók (Papez-kör), Tanulás, Éberség, Fej irányultsága (AD)||
|**Nuclei Mediales Thalami** (főként Nucleus Mediodorsalis - MD/DM)|Prefrontális kéreg (reciprok), Amygdala, Olfactorius kéreg, Hypothalamus, Bazális ganglionok (ventral pallidum), Substantia nigra, Intralamináris magok|Prefrontális kéreg (reciprok, topográfikus), Gyrus cinguli, Insula, Premotor kéreg, Parietális kéreg|Kognitív funkciók (tervezés, végrehajtó funkciók, munkamemória, döntéshozatal), Figyelem, Emóciók feldolgozása, Motiváció, Memória||
|**Nuclei Laterales Thalami - Ventrális csoport**|||||
|_Nucleus Ventralis Anterior (VA)_|Bazális ganglionok (GPi, SNr), Substantia nigra|Premotoros kéreg, Szupplementer motoros área (SMA)|Motoros tervezés, Mozgásindítás, Bazális ganglionok motoros hurkának része||
|_Nucleus Ventralis Lateralis (VL)_|Cerebellum (Nucl. dentatus, interpositus), Bazális ganglionok (GPi, SNr), Nucl. ruber|Primer motoros kéreg (M1), Premotoros kéreg, SMA|Mozgáskoordináció, -tervezés, -finomítás, Cerebelláris és bazális ganglion input integrálása||
|_Nucleus Ventralis Posterolateralis (VPL)_|Lemniscus medialis, Tractus spinothalamicus (test, végtagok)|Primer somatoszenzoros kéreg (SI) (test, végtagok repr.)|Tapintás, Fájdalom, Hő, Vibráció, Propriocepció (test, végtagok)||
|_Nucleus Ventralis Posteromedialis (VPM)_|Tractus trigeminothalamicus (arc), Nucl. tractus solitarii (ízérzés)|Primer somatoszenzoros kéreg (SI) (arc repr.), Primer ízérző kéreg|Tapintás, Fájdalom, Hő, Propriocepció (arc), Ízérzés||
|**Nuclei Laterales Thalami - Laterális Dorzális/Poszterior csoport**|||||
|_Nucleus Lateralis Dorsalis (LD)_|Hippocampus, Gyrus cinguli, Retrospleniális kéreg, Vizuális kéreg (area 18a), SpVi (vibrissa)|Limbikus kéreg (Gyrus cinguli, Retrospleniális kéreg), Parietális kéreg|Limbikus funkciók, Térbeli tanulás és memória, Vizuális-szenzoros integráció||
|_Nucleus Lateralis Posterior (LP)_|Superior colliculus, Pretectum, Parietális kéreg, Occipitális kéreg|Parietális asszociációs kéreg, Temporális lebeny, Vizuális asszociációs kéreg|Komplex szenzoros integráció (vizuális, somatoszenzoros), Figyelem, Vizuomotoros funkciók||
|_Pulvinar_ (inferior, lateralis, medialis, anterior részek)|Superior colliculus, Látókéreg (primer, asszociációs), Parietális, Temporális, Prefrontális kéreg|Vizuális asszociációs kéreg (parietális, temporális, occipitális), Prefrontális kéreg, Gyrus cinguli|Vizuális információfeldolgozás, Figyelem (vizuális, szelektív), Szemmozgások, Vizuospaciális funkciók, Nyelv, Multiszenzoros integráció, Kognitív funkciók (PM)||
|**Nuclei Intralaminares Thalami** (CL, CM, PCN, **CM-Pf komplex**)|Formatio reticularis (ARAS), Gerincvelő (Tr. spinothalamicus), Cerebellum, Globus pallidus, Prefrontális kéreg, Superior colliculus (Pf)|Diffúz projekciók a teljes agykéregre, Striatum (főként CM-Pf), Más thalamus magok|Agyi éberségi szint (arousal), Tudatosság, Figyelem, Fájdalomérzés modulációja (affektív komponens), Motoros kontroll (bazális ganglionok modulációja), Kogníció||
|**Nuclei Medianae Thalami (Középvonali magok)** (pl. Paraventricularis, Reuniens)|Hypothalamus, Formatio reticularis, Amygdala, Hippocampus, Prefrontális kéreg, Szaglókéreg|Amygdala, Hippocampus, Prefrontális kéreg, Gyrus cinguli, Striatum (N. accumbens), Hypothalamus|Limbikus funkciók, Vegetatív szabályozás, Emóciók, Motiváció, Memória, Éberség, Fájdalomérzés, Visceroszenzoros integráció||
|**Nucleus Reticularis Thalami (TRN)**|Kollaterálisok thalamokortikális és kortikothalamikus rostokból, Agytörzs, Bazális előagy|Kizárólag a thalamus többi (dorzális) magjához (GABAerg gátlás)|Thalamus aktivitásának gátló modulációja ("kapuőr"), Szenzoros szűrés, Figyelem, Alvási orsók generálása, Tudatosság||

 

A **Nucleus Reticularis Thalami (TRN)** egyedülálló a thalamikus magok között. Ez egy vékony, héjszerű neuronréteg, amely a thalamus laterális és elülső felszínét borítja, a lamina medullaris externa és a capsula interna között helyezkedik el. Kizárólag GABAerg gátló neuronokból áll, és abban különbözik a többi thalamikus magtól, hogy **nem projiciál az agykéregbe**. Ehelyett afferenseit a thalamokortikális és kortikothalamikus pályák kollaterálisaiból, valamint az agytörzsből kapja, efferenseit pedig kizárólag a thalamus többi, dorzális magjához küldi, ahol gátló hatást fejt ki. Ez a "thalamus a thalamusért" jellegű szabályozás lehetővé teszi a TRN számára, hogy a thalamus saját aktivitását finomhangolja és prioritizálja a kéreg felé továbbítandó információkat. Ez a mechanizmus kritikus a szelektív figyelem, a szenzoros információk szűrése ("gating") és a tudatos észlelés szempontjából. A TRN fontos szerepet játszik az agykérgi és thalamikus oszcillációk, például az alvási orsók generálásában és szinkronizációjában is. Diszfunkciója összefüggésbe hozható epilepsziával (különösen absence rohamokkal), alvászavarokkal, figyelemzavarokkal és skizofréniával.  

### C. Általános funkciók és klinikai jelentőség

A thalamus sokrétű funkciói a fentebb részletezett magcsoportok specifikus kapcsolatain és működésén alapulnak. Összefoglalva a legfontosabbakat:

- **Szenzoros relé és integráció:** A szaglás kivételével minden szenzoros információ (tapintás, fájdalom, hő, propriocepció, látás, hallás, ízérzés) a thalamuson keresztül éri el az agykérget, ahol tudatosul. A thalamus nemcsak továbbítja, hanem előzetesen fel is dolgozza, szűri és integrálja ezeket az információkat.  
    
- **Motoros kontroll:** A VA és VL magok révén a thalamus a bazális ganglionok és a cerebellum motoros hurkainak fontos állomása, részt vesz a mozgások tervezésében, iniciálásában, koordinációjában és finomításában.  
...
- **Lamina medullaris interna** → Y-alakú fehérállomány, magokat választ el
